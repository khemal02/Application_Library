...
export const changeRequestsApi = {
  ...
  advanceStage: (appId, id, stage, payload) => api
    .patch(`/applications/${appId}/change-requests/${id}/stages/${stage}/advance`, payload).then((r) => r.data),
  sendBackStage: (appId, id, stage, reason) => api
    .patch(`/applications/${appId}/change-requests/${id}/stages/${stage}/send-back`, { reason }).then((r) => r.data),
  statusHistory: (appId, id) => api
    .get(`/applications/${appId}/change-requests/${id}/status-history`).then((r) => r.data),
  ...
  implement: (appId, id) => api
    .patch(`/applications/${appId}/change-requests/${id}/implement`).then((r) => r.data),
...
export const applicationTrackingApi = {
  ...
  advanceStage: (id, stage, payload) => api.patch(`/application-tracking/${id}/stages/${stage}/advance`, payload).then((r) => r.data),
