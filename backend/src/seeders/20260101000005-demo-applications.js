    ...
    await queryInterface.bulkInsert('applications', [
      {
        ...
        status: 'in_progress', priority: 'high', start_date: '2026-01-15', current_version: '1.0.0',
      ...
      },
      {
        ...
        status: 'completed', priority: 'medium', start_date: '2025-08-01', release_date: '2025-11-10', current_version: '2.3.0',
      ...
      },
      {
        ...
        status: 'planning', priority: 'medium', start_date: '2026-06-01',
